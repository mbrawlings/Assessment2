...
//console.log(greetUser('mbrawlings'))
...
//CODE HERE
let percOff = deals[0].title.replace('15', '10')
deals[0].title = percOff
...
let dealUpdate = deals[1].desc.replace('March','April').trim()
deals[1].desc = dealUpdate
