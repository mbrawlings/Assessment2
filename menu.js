...
const pizza = {
    ...
    popularity: 4.5,
    rating: 4,
    tags: ['gluten-free','kids','meat','cheese']
}
...
const filteredFood = foodArr.filter(function(element) {return element.tags.includes('cheese')})
...
//CODE HERE
//const filterByProperty = foodArr.filter(function(element) {return element.tags.includes('cheese')})
function filterByProperty(property, number, type) {
    let filteredArr = foodArr.filter(function(element){return element.tags.includes('cheese')})
}
